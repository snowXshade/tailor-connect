...
const MyAppointments = () => {
  ...
  return (
    <div>
      ...
      <div>
        {
          Tailors.slice(0,2).map((item,index)=>(
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b'>
              <div>
                <img className='w-32 bg-indigo-50' src={item.profilePic} alt="" />
              </div>
              ...
              <div className='flex flex-col gap-2 justify-end'>
                <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-emerald-300 hover:text-black transition-all duration-300'>Pay Online</button>
